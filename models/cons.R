...
age.msim <- cbind(m16_19,m20_24,m25_34,m35_54,m55_60,m60_plus,
                  f16_19,f20_24,f25_34,f35_54,f55_60,f60_plus)

# Census data (age.msim) now ready to re-weight survey
...
mode.msim <- as.matrix(mode.const.clean)
rm(mode.const.clean)
...
nssec.msim <- as.matrix(nssec.const.clean)
