...
con1 <- data.frame(m. <- con1$X1.5, m6 = con1$X6.15, m16 = con1$X16.30, 
                   m3. <- con1$X31.37, m38 = con1$X38.48, m49 = con1$X49.or.more,
                   # now females
                   f. <- con1$X1.5.1, f6 = con1$X6.15.1, f16 = con1$X16.30.1, 
                   f3. <- con1$X31.37.1, f38 = con1$X38.48.1, 
