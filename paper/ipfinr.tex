...
The process of aggregation is performed in three steps:  % commented out as it's not amazing
\begin{enumerate}
...
In terms of TAE and SAE, the same trend apparent
...
the rate of improvement in model fit plateaus after the first iterate: 
...
by the falling percentage change in TAE in \cref{tciterations}.
