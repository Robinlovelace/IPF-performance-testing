...
of the publication of `public use microdata samples' PUMS in the USA, where the
``benefits of data dissemination are potentially enormous'' (p.~1) but where
there is little consensus about the right balance right `tolerance to risk'
of individuals being identified.
In the UK, to take another example, a 2\% Sample of Anonymised
Records (SARs) taken from the 1991 Census was released to academic researchers
\citep{marsh1993,middleton1995samples}. This has been followed by similar SARs releases in 2001
and 2011.
Due to increased ability to to store, process and transfer such `big microdata',
alongside increasing awareness of its potential benefits for public policy making,
\citet{ruggles2014big} suggests that researchers ``will soon have [access to] individual-level
information about entire populations or large samples covering most of the world’s population with
multiple observations at high geographic resolution'' (p.~297). Indeed, the mass collection
and analysis of individual-level information from mobile phones and other sources
is already a reality in some sectors.

Nevertheless, most official microdatasets, such as the SARs and the PUMS,
are not suitable for local and neighbourhood level
analysis due to the low level of geographic resolution allocated to each
individual to preserve confidentiality.
...
social attitudes) that are not collected by the Census at all in many countries,
...
spatial microsimulation \citep{Ballas2005c,Hermes2012a}. There
