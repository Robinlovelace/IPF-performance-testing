...
with a few modifications, on that provided in the Supplementary Information of
...
language, via the recently published
\textbf{ipfp} package.\footnote{This package is
...
fit using IPF and computational efficiency. Potentially more important is the
wider contribution: an illustration of systematic model testing and evaluation, which
could be applied to many other procedures currently taken for granted in the social sciences.
