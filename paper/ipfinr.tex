...
%opening
\title{Evaluating the performance of Iterative Proportional Fitting for spatial microsimulation: new tests to optimise an established technique}
...
spatial microsimulation. IPF enables the generation
