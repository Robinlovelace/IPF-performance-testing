...
much else to do. The existing literature called
for increased model testing and validation in spatial
microsimulation.
This paper has responded, by providing reproducible insights into the factors affecting model
fit and computational efficiency. The
wider contribution is an illustration of the utility of model testing:
