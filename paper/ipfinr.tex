...
\emph{spatial microsimulation}. In simplistic terms IPF can be understood
...
yet \emph{practical} demonstrations, focused on making
algorithm as accessible as possible to others,
is lacking. \citet{Norman1999a} and
and xxx exemplify their work with code snippets from an implementation
...
\citep{Ballas2005c} demonstrates IPF with a worked example
...
% This section builds this work, first outlining an example that
% can be completed in one's head before illustrating its implementation in code.
...
It is worth restating that IPF is a simple statistical procedure,
