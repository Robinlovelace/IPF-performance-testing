...
\begin{itemize}
 \item To preserve anonymity of participants \citep{Lee2009,marsh1993}.
 \item To ease storage and retrieval of information ---
 aggregate-level datasets can represent information about millions of individuals
in relatively little computer disk space.
 \item To ease the loading, visualisation and
 analysis of official data geographical information systems (GIS).
\end{itemize}
