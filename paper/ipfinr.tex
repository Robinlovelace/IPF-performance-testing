...
\begin{table}[htbp]
\caption{Individual-level data for the simple scenario. Available on github from here...} % where???
\begin{center}
\begin{tabular}{rrl}
\toprule
...
Initial weights are set to k, a vector of length \verb num.ws ,
which are by default set as a function of \verb u \ which is in term
defined as \verb 1:num.ws :
...
\bibliography{/nfs/foe-fs-01_users/georl/repos/IPF-performance-testing/paper/ipflib.bib}
